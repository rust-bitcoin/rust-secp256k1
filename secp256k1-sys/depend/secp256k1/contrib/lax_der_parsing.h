 ...
 * instead if you have the choice (see rustsecp256k1_v0_13_ecdsa_signature_parse_der and
 * rustsecp256k1_v0_13_ecdsa_signature_parse_compact).
 *
 ...
 */
int rustsecp256k1_v0_13_ecdsa_signature_parse_der_lax(
