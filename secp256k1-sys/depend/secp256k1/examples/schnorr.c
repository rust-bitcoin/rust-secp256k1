...
int main(void) {
    ...
    /* Bonus example: if all we need is signature verification (and no key
       ...
       rustsecp256k1_v0_8_1_context_create(). We can simply use the static (i.e., global)
       context rustsecp256k1_v0_8_1_context_static. See its description in
       include/secp256k1.h for details. */
    is_signature_valid2 = rustsecp256k1_v0_8_1_schnorrsig_verify(rustsecp256k1_v0_8_1_context_static,
