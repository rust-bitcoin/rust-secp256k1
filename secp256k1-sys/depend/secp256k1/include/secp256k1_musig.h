 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_pubnonce_parse(
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_aggnonce_parse(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_partial_sig_parse(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_pubkey_agg(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 *                        according to `rustsecp256k1_v0_10_0_ec_seckey_verify`, this function
 ...
 *                     call to rustsecp256k1_v0_10_0_musig_nonce_gen and must be uniformly random.
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_nonce_gen(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 *     that if the same seckey is used with `rustsecp256k1_v0_10_0_musig_nonce_gen_counter`
 ...
 *                     derivation function (can be NULL)
 */
SECP256K1_API int rustsecp256k1_v0_10_0_musig_nonce_gen_counter(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_musig_secnonce *secnonce,
    rustsecp256k1_v0_10_0_musig_pubnonce *pubnonce,
