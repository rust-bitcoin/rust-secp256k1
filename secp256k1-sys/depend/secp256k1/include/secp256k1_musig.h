 ...
 *  platforms or versions. With the exception of `rustsecp256k1_v0_13_musig_secnonce`, the
 ...
 *  (yet).
 */
typedef struct rustsecp256k1_v0_13_musig_keyagg_cache {
    unsigned char data[197];
} rustsecp256k1_v0_13_musig_keyagg_cache;
 ...
 *  secret signing key.
 */
typedef struct rustsecp256k1_v0_13_musig_secnonce {
    unsigned char data[132];
} rustsecp256k1_v0_13_musig_secnonce;
 ...
 */
typedef struct rustsecp256k1_v0_13_musig_pubnonce {
    unsigned char data[132];
} rustsecp256k1_v0_13_musig_pubnonce;
 ...
 */
typedef struct rustsecp256k1_v0_13_musig_aggnonce {
    unsigned char data[132];
} rustsecp256k1_v0_13_musig_aggnonce;
 ...
 *  functions (yet).
 */
typedef struct rustsecp256k1_v0_13_musig_session {
    unsigned char data[133];
} rustsecp256k1_v0_13_musig_session;
 ...
 */
typedef struct rustsecp256k1_v0_13_musig_partial_sig {
    unsigned char data[36];
} rustsecp256k1_v0_13_musig_partial_sig;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_pubnonce_parse(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_pubnonce *nonce,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_pubnonce_serialize(
    const rustsecp256k1_v0_13_context *ctx,
    unsigned char *out66,
    const rustsecp256k1_v0_13_musig_pubnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_aggnonce_parse(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_aggnonce *nonce,
    const unsigned char *in66
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:    nonce: pointer to the nonce
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_aggnonce_serialize(
    const rustsecp256k1_v0_13_context *ctx,
    unsigned char *out66,
    const rustsecp256k1_v0_13_musig_aggnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_partial_sig_parse(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_partial_sig *sig,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_partial_sig_serialize(
    const rustsecp256k1_v0_13_context *ctx,
    unsigned char *out32,
    const rustsecp256k1_v0_13_musig_partial_sig *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *
 *  Before aggregating, the pubkeys can be sorted with `rustsecp256k1_v0_13_ec_pubkey_sort`
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_pubkey_agg(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_xonly_pubkey *agg_pk,
    rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1_v0_13_pubkey * const *pubkeys,
    size_t n_pubkeys
 ...
 *                    `musig_pubkey_agg`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_pubkey_get(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_pubkey *agg_pk,
    const rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *
 *  The tweaking method is the same as `rustsecp256k1_v0_13_ec_pubkey_tweak_add`. So after
 *  the following pseudocode buf and buf2 have identical contents (absent
 *  earlier failures).
 *
 *  rustsecp256k1_v0_13_musig_pubkey_agg(..., keyagg_cache, pubkeys, ...)
 *  rustsecp256k1_v0_13_musig_pubkey_get(..., agg_pk, keyagg_cache)
 *  rustsecp256k1_v0_13_musig_pubkey_ec_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  rustsecp256k1_v0_13_ec_pubkey_serialize(..., buf, ..., output_pk, ...)
 *  rustsecp256k1_v0_13_ec_pubkey_tweak_add(..., agg_pk, tweak32)
 *  rustsecp256k1_v0_13_ec_pubkey_serialize(..., buf2, ..., agg_pk, ...)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  If you are only computing a public key but not intending to create a
 *  signature for it, use `rustsecp256k1_v0_13_ec_pubkey_tweak_add` instead.
 *
 *  Returns: 0 if the arguments are invalid, 1 otherwise
 *  Args:            ctx: pointer to a context object
 ...
 *                        `rustsecp256k1_v0_13_ec_seckey_verify` and is not equal to the
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_pubkey_ec_tweak_add(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_pubkey *output_pubkey,
    rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
 ...
 *
 *  The tweaking method is the same as `rustsecp256k1_v0_13_xonly_pubkey_tweak_add`. So in
 *  the following pseudocode xonly_pubkey_tweak_add_check (absent earlier
 *  failures) returns 1.
 *
 *  rustsecp256k1_v0_13_musig_pubkey_agg(..., agg_pk, keyagg_cache, pubkeys, ...)
 *  rustsecp256k1_v0_13_musig_pubkey_xonly_tweak_add(..., output_pk, keyagg_cache, tweak32)
 *  rustsecp256k1_v0_13_xonly_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1_v0_13_xonly_pubkey_tweak_add_check(..., buf, ..., agg_pk, tweak32)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  If you are only computing a public key but not intending to create a
 *  signature for it, use `rustsecp256k1_v0_13_xonly_pubkey_tweak_add` instead.
 *
 *  Returns: 0 if the arguments are invalid, 1 otherwise
 *  Args:            ctx: pointer to a context object
 *  Out:   output_pubkey: pointer to a public key to store the result. Will be set
 ...
 *                        negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_pubkey_xonly_tweak_add(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_pubkey *output_pubkey,
    rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
    const unsigned char *tweak32
 ...
 *  rustsecp256k1_v0_13_musig_nonce_gen_counter.
 *
 ...
 *                     call to rustsecp256k1_v0_13_musig_nonce_gen and must be uniformly
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_nonce_gen(
    const rustsecp256k1_v0_13_context *ctx,
 ...
 *  corresponding public nonce that is intended to be sent to other signers.
 *
 *  This function differs from `rustsecp256k1_v0_13_musig_nonce_gen` by accepting a
 *  non-repeating counter value instead of a secret random value. This requires
 *  that a secret key is provided to `rustsecp256k1_v0_13_musig_nonce_gen_counter`
 *  (through the keypair argument), as opposed to `rustsecp256k1_v0_13_musig_nonce_gen`
 ...
 *     i.e., you must never call `rustsecp256k1_v0_13_musig_nonce_gen_counter` twice with
 *     the same keypair and nonrepeating_cnt value. For example, this implies
 *     that if the same keypair is used with `rustsecp256k1_v0_13_musig_nonce_gen_counter`
 ...
 *                     unique to this call to rustsecp256k1_v0_13_musig_nonce_gen.
 ...
 *                     derivation function (can be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_nonce_gen_counter(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_secnonce *secnonce,
    rustsecp256k1_v0_13_musig_pubnonce *pubnonce,
    uint64_t nonrepeating_cnt,
    const rustsecp256k1_v0_13_keypair *keypair,
    const unsigned char *msg32,
    const rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
    const unsigned char *extra_input32
 ...
 *                       greater than 0.
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_nonce_agg(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_aggnonce *aggnonce,
    const rustsecp256k1_v0_13_musig_pubnonce * const *pubnonces,
    size_t n_pubnonces
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_nonce_process(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_session *session,
    const rustsecp256k1_v0_13_musig_aggnonce *aggnonce,
    const unsigned char *msg32,
    const rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache
 ...
 *  signature with `rustsecp256k1_v0_13_musig_partial_sig_verify` to prevent random or
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_partial_sign(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_musig_partial_sig *partial_sig,
    rustsecp256k1_v0_13_musig_secnonce *secnonce,
    const rustsecp256k1_v0_13_keypair *keypair,
    const rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1_v0_13_musig_session *session
 ...
 *                    `musig_nonce_process`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_musig_partial_sig_verify(
    const rustsecp256k1_v0_13_context *ctx,
    const rustsecp256k1_v0_13_musig_partial_sig *partial_sig,
    const rustsecp256k1_v0_13_musig_pubnonce *pubnonce,
    const rustsecp256k1_v0_13_pubkey *pubkey,
    const rustsecp256k1_v0_13_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1_v0_13_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(6);
 ...
 *                     greater than 0.
 */
SECP256K1_API int rustsecp256k1_v0_13_musig_partial_sig_agg(
    const rustsecp256k1_v0_13_context *ctx,
    unsigned char *sig64,
    const rustsecp256k1_v0_13_musig_session *session,
    const rustsecp256k1_v0_13_musig_partial_sig * const *partial_sigs,
    size_t n_sigs
