 ...
 *  must be used.
 */
typedef struct rustsecp256k1_v0_13_silentpayments_recipient {
    rustsecp256k1_v0_13_pubkey scan_pubkey;
    rustsecp256k1_v0_13_pubkey spend_pubkey;
    uint32_t index;
} rustsecp256k1_v0_13_silentpayments_recipient;
 ...
 *                            (not rustsecp256k1_v0_13_context_static).
 ...
 *                            for the `rustsecp256k1_v0_13_silentpayments_recipient` object
 *                            with index = 0.
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_sender_create_outputs(
 ...
 *  `rustsecp256k1_v0_13_silentpayments_recipient_label_serialize` and
 *  `rustsecp256k1_v0_13_silentpayments_recipient_label_parse`.
 */
typedef struct rustsecp256k1_v0_13_silentpayments_label {
    unsigned char data[68];
} rustsecp256k1_v0_13_silentpayments_label;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_recipient_label_parse(
    const rustsecp256k1_v0_13_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_13_silentpayments_recipient_label_serialize(
    const rustsecp256k1_v0_13_context *ctx,
    unsigned char *out33,
    const rustsecp256k1_v0_13_silentpayments_label *label
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_recipient_label_create(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_silentpayments_label *label,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_recipient_create_labeled_spend_pubkey(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_pubkey *labeled_spend_pubkey,
    const rustsecp256k1_v0_13_pubkey *unlabeled_spend_pubkey,
    const rustsecp256k1_v0_13_silentpayments_label *label
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *  `rustsecp256k1_v0_13_silentpayments_recipient_prevouts_summary_create`.
 */
typedef struct rustsecp256k1_v0_13_silentpayments_prevouts_summary {
    unsigned char data[101];
} rustsecp256k1_v0_13_silentpayments_prevouts_summary;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_recipient_prevouts_summary_create(
    const rustsecp256k1_v0_13_context *ctx,
 ...
 *  `rustsecp256k1_v0_13_silentpayments_recipient_label_create` and
 *  `rustsecp256k1_v0_13_silentpayments_recipient_label_serialize` can be used.
 *
 ...
 */
typedef const unsigned char* (*rustsecp256k1_v0_13_silentpayments_label_lookup)(const unsigned char* label33, const void* label_context);
 ...
 *                    an invalid value.
 */
typedef struct rustsecp256k1_v0_13_silentpayments_found_output {
    rustsecp256k1_v0_13_xonly_pubkey output;
    unsigned char tweak[32];
    int found_with_label;
    rustsecp256k1_v0_13_silentpayments_label label;
} rustsecp256k1_v0_13_silentpayments_found_output;
 ...
 *
 *  For creating the label cache, `rustsecp256k1_v0_13_silentpayments_recipient_label_create`
 *  and `rustsecp256k1_v0_13_silentpayments_recipient_label_serialize` can be used.
 *
 ...
 *                               key is valid if it passes rustsecp256k1_v0_13_ec_seckey_verify
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_13_silentpayments_recipient_scan_outputs(
    const rustsecp256k1_v0_13_context *ctx,
    rustsecp256k1_v0_13_silentpayments_found_output **found_outputs,
    uint32_t *n_found_outputs,
    const rustsecp256k1_v0_13_xonly_pubkey **tx_outputs,
