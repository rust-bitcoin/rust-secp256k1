 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_create_label_tweak(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 *                                key
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_create_labelled_spend_pubkey(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *labelled_spend_pubkey,
 ...
 *  `rustsecp256k1_v0_10_0_silentpayments_public_data_create`. Can be serialized as a
 *  compressed public key using
 *  `rustsecp256k1_v0_10_0_silentpayments_public_data_serialize`. The serialization is
 *  intended for sending the public input data to light clients. Light clients
 *  can use this serialization with
 *  `rustsecp256k1_v0_10_0_silentpayments_public_data_parse`.
 */
typedef struct {
    unsigned char data[98];
} rustsecp256k1_v0_10_0_silentpayments_public_data;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_public_data_create(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 *                     object
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_public_data_serialize(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_public_data_parse(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_silentpayments_public_data *public_data,
 ...
 *
 *  Given the public input data (rustsecp256k1_v0_10_0_silentpayments_public_data),
 ...
 *  transaction, `rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs` should be
 *  used instead.
 *
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_create_shared_secret(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_silentpayments_recipient_create_output_pubkey(
    const rustsecp256k1_v0_10_0_context *ctx,
