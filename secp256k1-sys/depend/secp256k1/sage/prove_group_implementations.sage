...
if __name__ == "__main__":
  ...
  success = success & check_symbolic_jacobian_weierstrass("rustsecp256k1_v0_8_1_gej_add_ge", 0, 7, 8, formula_rustsecp256k1_v0_8_1_gej_add_ge)
  ...
  if len(sys.argv) >= 2 and sys.argv[1] == "--exhaustive":
    ...
    success = success & check_exhaustive_jacobian_weierstrass("rustsecp256k1_v0_8_1_gej_add_ge", 0, 7, 8, formula_rustsecp256k1_v0_8_1_gej_add_ge, 43)
