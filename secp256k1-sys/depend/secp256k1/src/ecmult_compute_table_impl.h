...
static void rustsecp256k1_v0_8_0_ecmult_compute_table(rustsecp256k1_v0_8_0_ge_storage* table, int window_g, const rustsecp256k1_v0_8_0_gej* gen) {
    ...
    rustsecp256k1_v0_8_0_ge ge, dgen;
    int j;

    gj = *gen;
    rustsecp256k1_v0_8_0_ge_set_gej_var(&ge, &gj);
    rustsecp256k1_v0_8_0_ge_to_storage(&table[0], &ge);

    rustsecp256k1_v0_8_0_gej_double_var(&gj, gen, NULL);
    rustsecp256k1_v0_8_0_ge_set_gej_var(&dgen, &gj);

    for (j = 1; j < ECMULT_TABLE_SIZE(window_g); ++j) {
        rustsecp256k1_v0_8_0_gej_set_ge(&gj, &ge);
        rustsecp256k1_v0_8_0_gej_add_ge_var(&gj, &gj, &dgen, NULL);
        rustsecp256k1_v0_8_0_ge_set_gej_var(&ge, &gj);
        rustsecp256k1_v0_8_0_ge_to_storage(&table[j], &ge);
    }
}
...
static void rustsecp256k1_v0_8_0_ecmult_compute_two_tables(rustsecp256k1_v0_8_0_ge_storage* table, rustsecp256k1_v0_8_0_ge_storage* table_128, int window_g, const rustsecp256k1_v0_8_0_ge* gen) {
    ...
    rustsecp256k1_v0_8_0_ecmult_compute_table(table, window_g, &gj);
    for (i = 0; i < 128; ++i) {
        rustsecp256k1_v0_8_0_gej_double_var(&gj, &gj, NULL);
    }
    rustsecp256k1_v0_8_0_ecmult_compute_table(table_128, window_g, &gj);
}
