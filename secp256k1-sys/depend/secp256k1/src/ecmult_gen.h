 ...
 * rustsecp256k1_v0_13_ge_storages.
 *
 ...
 * the table cannot have infinities in them (rustsecp256k1_v0_13_ge_storage
...
typedef struct {
    ...
    rustsecp256k1_v0_13_scalar scalar_offset;
    rustsecp256k1_v0_13_ge ge_offset;

    /* Factor used for projective blinding. This value is used to rescale the Z
     * coordinate of the first table lookup. */
    rustsecp256k1_v0_13_fe proj_blind;
} rustsecp256k1_v0_13_ecmult_gen_context;
...
static void rustsecp256k1_v0_13_ecmult_gen(const rustsecp256k1_v0_13_ecmult_gen_context* ctx, rustsecp256k1_v0_13_gej *r, const rustsecp256k1_v0_13_scalar *a);
