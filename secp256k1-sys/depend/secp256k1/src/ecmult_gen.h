 ...
 * rustsecp256k1_v0_10_0_ge_storages.
 *
 ...
 * the table cannot have infinities in them (rustsecp256k1_v0_10_0_ge_storage
...
typedef struct {
    ...
    rustsecp256k1_v0_10_0_scalar scalar_offset;
    rustsecp256k1_v0_10_0_ge ge_offset;

    /* Factor used for projective blinding. This value is used to rescale the Z
     * coordinate of the first table lookup. */
    rustsecp256k1_v0_10_0_fe proj_blind;
