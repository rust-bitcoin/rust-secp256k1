...
static int rustsecp256k1_v0_10_0_ecmult_wnaf(int *wnaf, int len, const rustsecp256k1_v0_10_0_scalar *a, int w) {
    ...
    while (bit < len) {
        int now;
        int word;
        if (rustsecp256k1_v0_10_0_scalar_get_bits_limb32(&s, bit, 1) == (unsigned int)carry) {
            bit++;
            continue;
        }
...
#ifdef VERIFY
    {
        ...
        while (verify_bit < 256) {
            VERIFY_CHECK(rustsecp256k1_v0_10_0_scalar_get_bits_limb32(&s, verify_bit, 1) == 0);
            verify_bit++;
        }
    }
#endif
...
static void rustsecp256k1_v0_10_0_ecmult_strauss_wnaf(const struct rustsecp256k1_v0_10_0_strauss_state *state, rustsecp256k1_v0_10_0_gej *r, size_t num, const rustsecp256k1_v0_10_0_gej *a, const rustsecp256k1_v0_10_0_scalar *na, const rustsecp256k1_v0_10_0_scalar *ng) {
    rustsecp256k1_v0_10_0_ge tmpa;
    ...
    for (np = 0; np < num; ++np) {
        ...
        rustsecp256k1_v0_10_0_scalar na_1, na_lam;
        ...
        rustsecp256k1_v0_10_0_ecmult_odd_multiples_table(ECMULT_TABLE_SIZE(WINDOW_A), state->pre_a + no * ECMULT_TABLE_SIZE(WINDOW_A), state->aux + no * ECMULT_TABLE_SIZE(WINDOW_A), &Z, &tmp);
        if (no) rustsecp256k1_v0_10_0_fe_mul(state->aux + no * ECMULT_TABLE_SIZE(WINDOW_A), state->aux + no * ECMULT_TABLE_SIZE(WINDOW_A), &(a[np].z));
    ...
    if (no) {
        rustsecp256k1_v0_10_0_ge_table_set_globalz(ECMULT_TABLE_SIZE(WINDOW_A) * no, state->pre_a, state->aux);
    }

    for (np = 0; np < no; ++np) {
        for (i = 0; i < ECMULT_TABLE_SIZE(WINDOW_A); i++) {
            rustsecp256k1_v0_10_0_fe_mul(&state->aux[np * ECMULT_TABLE_SIZE(WINDOW_A) + i], &state->pre_a[np * ECMULT_TABLE_SIZE(WINDOW_A) + i].x, &rustsecp256k1_v0_10_0_const_beta);
        }
    }
...
static int rustsecp256k1_v0_10_0_ecmult_strauss_batch(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch, rustsecp256k1_v0_10_0_gej *r, const rustsecp256k1_v0_10_0_scalar *inp_g_sc, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void *cbdata, size_t n_points, size_t cb_offset) {
    ...
    points = (rustsecp256k1_v0_10_0_gej*)rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, n_points * sizeof(rustsecp256k1_v0_10_0_gej));
    scalars = (rustsecp256k1_v0_10_0_scalar*)rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, n_points * sizeof(rustsecp256k1_v0_10_0_scalar));
    state.aux = (rustsecp256k1_v0_10_0_fe*)rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, n_points * ECMULT_TABLE_SIZE(WINDOW_A) * sizeof(rustsecp256k1_v0_10_0_fe));
    state.pre_a = (rustsecp256k1_v0_10_0_ge*)rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, n_points * ECMULT_TABLE_SIZE(WINDOW_A) * sizeof(rustsecp256k1_v0_10_0_ge));
    state.ps = (struct rustsecp256k1_v0_10_0_strauss_point_state*)rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, n_points * sizeof(struct rustsecp256k1_v0_10_0_strauss_point_state));
    ...
    for (i = 0; i < n_points; i++) {
        ...
        rustsecp256k1_v0_10_0_gej_set_ge(&points[i], &point);
    }
    rustsecp256k1_v0_10_0_ecmult_strauss_wnaf(&state, r, n_points, points, scalars, inp_g_sc);
    rustsecp256k1_v0_10_0_scratch_apply_checkpoint(error_callback, scratch, scratch_checkpoint);
    return 1;
}

/* Wrapper for rustsecp256k1_v0_10_0_ecmult_multi_func interface */
static int rustsecp256k1_v0_10_0_ecmult_strauss_batch_single(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch, rustsecp256k1_v0_10_0_gej *r, const rustsecp256k1_v0_10_0_scalar *inp_g_sc, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void *cbdata, size_t n) {
    return rustsecp256k1_v0_10_0_ecmult_strauss_batch(error_callback, scratch, r, inp_g_sc, cb, cbdata, n, 0);
}

static size_t rustsecp256k1_v0_10_0_strauss_max_points(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch) {
    return rustsecp256k1_v0_10_0_scratch_max_allocation(error_callback, scratch, STRAUSS_SCRATCH_OBJECTS) / rustsecp256k1_v0_10_0_strauss_scratch_size(1);
}
...
static int rustsecp256k1_v0_10_0_ecmult_pippenger_batch(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch, rustsecp256k1_v0_10_0_gej *r, const rustsecp256k1_v0_10_0_scalar *inp_g_sc, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void *cbdata, size_t n_points, size_t cb_offset) {
     ...
     * other scalars. */
    size_t entries = 2*n_points + 2;
    rustsecp256k1_v0_10_0_ge *points;
    rustsecp256k1_v0_10_0_scalar *scalars;
    rustsecp256k1_v0_10_0_gej *buckets;
    ...
    bucket_window = rustsecp256k1_v0_10_0_pippenger_bucket_window(n_points);
     ...
     * accordingly. */
    points = (rustsecp256k1_v0_10_0_ge *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, entries * sizeof(*points));
    scalars = (rustsecp256k1_v0_10_0_scalar *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, entries * sizeof(*scalars));
    state_space = (struct rustsecp256k1_v0_10_0_pippenger_state *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, sizeof(*state_space));
    if (points == NULL || scalars == NULL || state_space == NULL) {
        rustsecp256k1_v0_10_0_scratch_apply_checkpoint(error_callback, scratch, scratch_checkpoint);
        return 0;
    }
    state_space->ps = (struct rustsecp256k1_v0_10_0_pippenger_point_state *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, entries * sizeof(*state_space->ps));
    state_space->wnaf_na = (int *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, entries*(WNAF_SIZE(bucket_window+1)) * sizeof(int));
    buckets = (rustsecp256k1_v0_10_0_gej *) rustsecp256k1_v0_10_0_scratch_alloc(error_callback, scratch, ((size_t)1 << bucket_window) * sizeof(*buckets));
    ...
    if (inp_g_sc != NULL) {
        scalars[0] = *inp_g_sc;
        points[0] = rustsecp256k1_v0_10_0_ge_const_g;
        idx++;
        rustsecp256k1_v0_10_0_ecmult_endo_split(&scalars[0], &scalars[1], &points[0], &points[1]);
        idx++;
    }
    ...
    while (point_idx < n_points) {
        ...
        idx++;
        rustsecp256k1_v0_10_0_ecmult_endo_split(&scalars[idx - 1], &scalars[idx], &points[idx - 1], &points[idx]);
        idx++;
        point_idx++;
    }
...
/* Wrapper for rustsecp256k1_v0_10_0_ecmult_multi_func interface */
static int rustsecp256k1_v0_10_0_ecmult_pippenger_batch_single(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch, rustsecp256k1_v0_10_0_gej *r, const rustsecp256k1_v0_10_0_scalar *inp_g_sc, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void *cbdata, size_t n) {
    return rustsecp256k1_v0_10_0_ecmult_pippenger_batch(error_callback, scratch, r, inp_g_sc, cb, cbdata, n, 0);
}
 ...
 * used.
 */
static size_t rustsecp256k1_v0_10_0_pippenger_max_points(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch) {
    size_t max_alloc = rustsecp256k1_v0_10_0_scratch_max_allocation(error_callback, scratch, PIPPENGER_SCRATCH_OBJECTS);
    int bucket_window;
    size_t res = 0;

    for (bucket_window = 1; bucket_window <= PIPPENGER_MAX_BUCKET_WINDOW; bucket_window++) {
        size_t n_points;
        size_t max_points = rustsecp256k1_v0_10_0_pippenger_bucket_window_inv(bucket_window);
        size_t space_for_points;
        size_t space_overhead;
        size_t entry_size = sizeof(rustsecp256k1_v0_10_0_ge) + sizeof(rustsecp256k1_v0_10_0_scalar) + sizeof(struct rustsecp256k1_v0_10_0_pippenger_point_state) + (WNAF_SIZE(bucket_window+1)+1)*sizeof(int);

        entry_size = 2*entry_size;
        space_overhead = (sizeof(rustsecp256k1_v0_10_0_gej) << bucket_window) + entry_size + sizeof(struct rustsecp256k1_v0_10_0_pippenger_state);
...
typedef int (*rustsecp256k1_v0_10_0_ecmult_multi_func)(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch*, rustsecp256k1_v0_10_0_gej*, const rustsecp256k1_v0_10_0_scalar*, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void*, size_t);
static int rustsecp256k1_v0_10_0_ecmult_multi_var(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch *scratch, rustsecp256k1_v0_10_0_gej *r, const rustsecp256k1_v0_10_0_scalar *inp_g_sc, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void *cbdata, size_t n) {
    ...
    int (*f)(const rustsecp256k1_v0_10_0_callback* error_callback, rustsecp256k1_v0_10_0_scratch*, rustsecp256k1_v0_10_0_gej*, const rustsecp256k1_v0_10_0_scalar*, rustsecp256k1_v0_10_0_ecmult_multi_callback cb, void*, size_t, size_t);
    size_t n_batches;
    ...
    if (inp_g_sc == NULL && n == 0) {
        ...
        rustsecp256k1_v0_10_0_ecmult(r, r, &rustsecp256k1_v0_10_0_scalar_zero, inp_g_sc);
        return 1;
    }
    if (scratch == NULL) {
        return rustsecp256k1_v0_10_0_ecmult_multi_simple_var(r, inp_g_sc, cb, cbdata, n);
    }
    ...
    if (!rustsecp256k1_v0_10_0_ecmult_multi_batch_size_helper(&n_batches, &n_batch_points, rustsecp256k1_v0_10_0_pippenger_max_points(error_callback, scratch), n)) {
        return rustsecp256k1_v0_10_0_ecmult_multi_simple_var(r, inp_g_sc, cb, cbdata, n);
    }
    if (n_batch_points >= ECMULT_PIPPENGER_THRESHOLD) {
        f = rustsecp256k1_v0_10_0_ecmult_pippenger_batch;
    } else {
        if (!rustsecp256k1_v0_10_0_ecmult_multi_batch_size_helper(&n_batches, &n_batch_points, rustsecp256k1_v0_10_0_strauss_max_points(error_callback, scratch), n)) {
            return rustsecp256k1_v0_10_0_ecmult_multi_simple_var(r, inp_g_sc, cb, cbdata, n);
        }
        f = rustsecp256k1_v0_10_0_ecmult_strauss_batch;
    }
    for(i = 0; i < n_batches; i++) {
        ...
        rustsecp256k1_v0_10_0_gej_add_var(r, r, &tmp, NULL);
        n -= nbp;
    }
    return 1;
}
