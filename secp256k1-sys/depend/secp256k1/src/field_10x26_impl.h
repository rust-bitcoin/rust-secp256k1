...
#ifdef VERIFY
static void rustsecp256k1_v0_5_0_fe_verify(const rustsecp256k1_v0_5_0_fe *a) {
...
SECP256K1_INLINE static void rustsecp256k1_v0_5_0_fe_set_int(rustsecp256k1_v0_5_0_fe *r, int a) {
...
SECP256K1_INLINE static int rustsecp256k1_v0_5_0_fe_is_zero(const rustsecp256k1_v0_5_0_fe *a) {
...
SECP256K1_INLINE static int rustsecp256k1_v0_5_0_fe_is_odd(const rustsecp256k1_v0_5_0_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    rustsecp256k1_v0_5_0_fe_verify(a);
#endif
...
SECP256K1_INLINE static void rustsecp256k1_v0_5_0_fe_clear(rustsecp256k1_v0_5_0_fe *a) {
    int i;
#ifdef VERIFY
    a->magnitude = 0;
    a->normalized = 1;
...
void rustsecp256k1_v0_5_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b);
void rustsecp256k1_v0_5_0_fe_sqr_inner(uint32_t *r, const uint32_t *a);
...
SECP256K1_INLINE static void rustsecp256k1_v0_5_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
SECP256K1_INLINE static void rustsecp256k1_v0_5_0_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
static void rustsecp256k1_v0_5_0_fe_from_signed30(rustsecp256k1_v0_5_0_fe *r, const rustsecp256k1_v0_5_0_modinv32_signed30 *a) {
...
static void rustsecp256k1_v0_5_0_fe_to_signed30(rustsecp256k1_v0_5_0_modinv32_signed30 *r, const rustsecp256k1_v0_5_0_fe *a) {
...
static const rustsecp256k1_v0_5_0_modinv32_modinfo rustsecp256k1_v0_5_0_const_modinfo_fe = {
    {{-0x3D1, -4, 0, 0, 0, 0, 0, 0, 65536}},
    0x2DDACACFL
};

static void rustsecp256k1_v0_5_0_fe_inv(rustsecp256k1_v0_5_0_fe *r, const rustsecp256k1_v0_5_0_fe *x) {
    rustsecp256k1_v0_5_0_fe tmp;
    rustsecp256k1_v0_5_0_modinv32_signed30 s;

    tmp = *x;
    rustsecp256k1_v0_5_0_fe_normalize(&tmp);
    rustsecp256k1_v0_5_0_fe_to_signed30(&s, &tmp);
    rustsecp256k1_v0_5_0_modinv32(&s, &rustsecp256k1_v0_5_0_const_modinfo_fe);
    rustsecp256k1_v0_5_0_fe_from_signed30(r, &s);

    VERIFY_CHECK(rustsecp256k1_v0_5_0_fe_normalizes_to_zero(r) == rustsecp256k1_v0_5_0_fe_normalizes_to_zero(&tmp));
}

static void rustsecp256k1_v0_5_0_fe_inv_var(rustsecp256k1_v0_5_0_fe *r, const rustsecp256k1_v0_5_0_fe *x) {
    rustsecp256k1_v0_5_0_fe tmp;
    rustsecp256k1_v0_5_0_modinv32_signed30 s;
    ...
    rustsecp256k1_v0_5_0_fe_to_signed30(&s, &tmp);
    rustsecp256k1_v0_5_0_modinv32_var(&s, &rustsecp256k1_v0_5_0_const_modinfo_fe);
    rustsecp256k1_v0_5_0_fe_from_signed30(r, &s);
