...
void rustsecp256k1_v0_8_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b);
void rustsecp256k1_v0_8_0_fe_sqr_inner(uint32_t *r, const uint32_t *a);
...
SECP256K1_INLINE static void rustsecp256k1_v0_8_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
SECP256K1_INLINE static void rustsecp256k1_v0_8_0_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
static void rustsecp256k1_v0_8_0_fe_from_signed30(rustsecp256k1_v0_8_0_fe *r, const rustsecp256k1_v0_8_0_modinv32_signed30 *a) {
...
static void rustsecp256k1_v0_8_0_fe_to_signed30(rustsecp256k1_v0_8_0_modinv32_signed30 *r, const rustsecp256k1_v0_8_0_fe *a) {
...
static const rustsecp256k1_v0_8_0_modinv32_modinfo rustsecp256k1_v0_8_0_const_modinfo_fe = {
...
static void rustsecp256k1_v0_8_0_fe_inv(rustsecp256k1_v0_8_0_fe *r, const rustsecp256k1_v0_8_0_fe *x) {
    ...
    rustsecp256k1_v0_8_0_fe_to_signed30(&s, &tmp);
    rustsecp256k1_v0_8_0_modinv32(&s, &rustsecp256k1_v0_8_0_const_modinfo_fe);
    rustsecp256k1_v0_8_0_fe_from_signed30(r, &s);
...
static void rustsecp256k1_v0_8_0_fe_inv_var(rustsecp256k1_v0_8_0_fe *r, const rustsecp256k1_v0_8_0_fe *x) {
    ...
    rustsecp256k1_v0_8_0_fe_to_signed30(&s, &tmp);
    rustsecp256k1_v0_8_0_modinv32_var(&s, &rustsecp256k1_v0_8_0_const_modinfo_fe);
    rustsecp256k1_v0_8_0_fe_from_signed30(r, &s);
