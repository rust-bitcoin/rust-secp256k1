...
static int rustsecp256k1_v0_8_1_fe_impl_is_square_var(const rustsecp256k1_v0_8_1_fe *x) {
    ...
    tmp = *x;
    rustsecp256k1_v0_8_1_fe_normalize_var(&tmp);
    /* rustsecp256k1_v0_8_1_jacobi32_maybe_var cannot deal with input 0. */
    if (rustsecp256k1_v0_8_1_fe_is_zero(&tmp)) return 1;
    rustsecp256k1_v0_8_1_fe_to_signed30(&s, &tmp);
    jac = rustsecp256k1_v0_8_1_jacobi32_maybe_var(&s, &rustsecp256k1_v0_8_1_const_modinfo_fe);
    if (jac == 0) {
        /* rustsecp256k1_v0_8_1_jacobi32_maybe_var failed to compute the Jacobi symbol. Fall back
