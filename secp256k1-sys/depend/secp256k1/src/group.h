...
typedef struct {
    rustsecp256k1_v0_6_1_fe x; /* actual X: x/z^2 */
    rustsecp256k1_v0_6_1_fe y; /* actual Y: y/z^3 */
    rustsecp256k1_v0_6_1_fe z;
    int infinity; /* whether this represents the point at infinity */
} rustsecp256k1_v0_6_1_gej;

#define SECP256K1_GEJ_CONST(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {SECP256K1_FE_CONST((a),(b),(c),(d),(e),(f),(g),(h)), SECP256K1_FE_CONST((i),(j),(k),(l),(m),(n),(o),(p)), SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 1), 0}
#define SECP256K1_GEJ_CONST_INFINITY {SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 0), SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 0), SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 0), 1}

typedef struct {
    rustsecp256k1_v0_6_1_fe_storage x;
    rustsecp256k1_v0_6_1_fe_storage y;
} rustsecp256k1_v0_6_1_ge_storage;
...
static void rustsecp256k1_v0_6_1_gej_double(rustsecp256k1_v0_6_1_gej *r, const rustsecp256k1_v0_6_1_gej *a);
...
/** Set r equal to the sum of a and b (with b given in affine coordinates). This is more efficient
    than rustsecp256k1_v0_6_1_gej_add_var. It is identical to rustsecp256k1_v0_6_1_gej_add_ge but without constant-time
...
/** Clear a rustsecp256k1_v0_6_1_gej to prevent leaking sensitive information. */
static void rustsecp256k1_v0_6_1_gej_clear(rustsecp256k1_v0_6_1_gej *r);

/** Clear a rustsecp256k1_v0_6_1_ge to prevent leaking sensitive information. */
...
static void rustsecp256k1_v0_6_1_gej_cmov(rustsecp256k1_v0_6_1_gej *r, const rustsecp256k1_v0_6_1_gej *a, int flag);

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized.*/
static void rustsecp256k1_v0_6_1_ge_storage_cmov(rustsecp256k1_v0_6_1_ge_storage *r, const rustsecp256k1_v0_6_1_ge_storage *a, int flag);

/** Rescale a jacobian point by b which must be non-zero. Constant-time. */
static void rustsecp256k1_v0_6_1_gej_rescale(rustsecp256k1_v0_6_1_gej *r, const rustsecp256k1_v0_6_1_fe *b);
