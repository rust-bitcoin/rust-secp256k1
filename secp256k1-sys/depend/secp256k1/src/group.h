 ...
 */
typedef struct {
    rustsecp256k1_v0_8_0_fe x; /* actual X: x/z^2 */
    rustsecp256k1_v0_8_0_fe y; /* actual Y: y/z^3 */
...
typedef struct {
    rustsecp256k1_v0_8_0_fe_storage x;
    rustsecp256k1_v0_8_0_fe_storage y;
...
static void rustsecp256k1_v0_8_0_gej_double(rustsecp256k1_v0_8_0_gej *r, const rustsecp256k1_v0_8_0_gej *a);
...
/** Set r equal to the sum of a and b (with b given in affine coordinates). This is more efficient
    than rustsecp256k1_v0_8_0_gej_add_var. It is identical to rustsecp256k1_v0_8_0_gej_add_ge but without constant-time
...
/** Clear a rustsecp256k1_v0_8_0_gej to prevent leaking sensitive information. */
static void rustsecp256k1_v0_8_0_gej_clear(rustsecp256k1_v0_8_0_gej *r);

/** Clear a rustsecp256k1_v0_8_0_ge to prevent leaking sensitive information. */
...
static void rustsecp256k1_v0_8_0_gej_cmov(rustsecp256k1_v0_8_0_gej *r, const rustsecp256k1_v0_8_0_gej *a, int flag);

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized.*/
static void rustsecp256k1_v0_8_0_ge_storage_cmov(rustsecp256k1_v0_8_0_ge_storage *r, const rustsecp256k1_v0_8_0_ge_storage *a, int flag);

/** Rescale a jacobian point by b which must be non-zero. Constant-time. */
static void rustsecp256k1_v0_8_0_gej_rescale(rustsecp256k1_v0_8_0_gej *r, const rustsecp256k1_v0_8_0_fe *b);
