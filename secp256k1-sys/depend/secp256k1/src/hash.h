...
static void rustsecp256k1_v0_11_sha256_write(rustsecp256k1_v0_11_sha256 *hash, const unsigned char *data, size_t size);
...
typedef struct {
    rustsecp256k1_v0_11_sha256 inner, outer;
} rustsecp256k1_v0_11_hmac_sha256;

static void rustsecp256k1_v0_11_hmac_sha256_initialize(rustsecp256k1_v0_11_hmac_sha256 *hash, const unsigned char *key, size_t size);
...
typedef struct {
    ...
    unsigned char k[32];
    int retry;
} rustsecp256k1_v0_11_rfc6979_hmac_sha256;
