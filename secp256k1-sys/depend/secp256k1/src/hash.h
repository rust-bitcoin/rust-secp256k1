...
typedef struct {
    ...
    size_t bytes;
} rustsecp256k1_v0_5_0_sha256;

static void rustsecp256k1_v0_5_0_sha256_initialize(rustsecp256k1_v0_5_0_sha256 *hash);
static void rustsecp256k1_v0_5_0_sha256_write(rustsecp256k1_v0_5_0_sha256 *hash, const unsigned char *data, size_t size);
static void rustsecp256k1_v0_5_0_sha256_finalize(rustsecp256k1_v0_5_0_sha256 *hash, unsigned char *out32);

typedef struct {
    rustsecp256k1_v0_5_0_sha256 inner, outer;
} rustsecp256k1_v0_5_0_hmac_sha256;

static void rustsecp256k1_v0_5_0_hmac_sha256_initialize(rustsecp256k1_v0_5_0_hmac_sha256 *hash, const unsigned char *key, size_t size);
...
typedef struct {
    ...
    unsigned char k[32];
    int retry;
} rustsecp256k1_v0_5_0_rfc6979_hmac_sha256;
