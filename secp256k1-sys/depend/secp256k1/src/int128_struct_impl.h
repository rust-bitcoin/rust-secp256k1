...
#        endif
static SECP256K1_INLINE uint64_t rustsecp256k1_v0_12_umul128(uint64_t a, uint64_t b, uint64_t* hi) {
    *hi = __umulh(a, b);
    return a * b;
}

static SECP256K1_INLINE int64_t rustsecp256k1_v0_12_mul128(int64_t a, int64_t b, int64_t* hi) {
    *hi = __mulh(a, b);
    return (uint64_t)a * (uint64_t)b;
}
#    else
/* On x84_64 MSVC, use native _(u)mul128 for 64x64->128 multiplications. */
#        define rustsecp256k1_v0_12_umul128 _umul128
#        define rustsecp256k1_v0_12_mul128 _mul128
#    endif
#else
...
static SECP256K1_INLINE void rustsecp256k1_v0_12_i128_dissip_mul(rustsecp256k1_v0_12_int128 *r, int64_t a, int64_t b) {
   int64_t hi;
   uint64_t lo = (uint64_t)rustsecp256k1_v0_12_mul128(a, b, &hi);
   hi += r->lo < lo;
   /* Verify no overflow.
...
static SECP256K1_INLINE void rustsecp256k1_v0_12_i128_det(rustsecp256k1_v0_12_int128 *r, int64_t a, int64_t b, int64_t c, int64_t d) {
   rustsecp256k1_v0_12_i128_mul(r, a, d);
   rustsecp256k1_v0_12_i128_dissip_mul(r, b, c);
}
...
static SECP256K1_INLINE int64_t rustsecp256k1_v0_12_i128_to_i64(const rustsecp256k1_v0_12_int128 *a) {
   ...
   return (int64_t)rustsecp256k1_v0_12_i128_to_u64(a);
}
