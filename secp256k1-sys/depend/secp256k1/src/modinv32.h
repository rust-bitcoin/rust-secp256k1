...
typedef struct {
    ...
    rustsecp256k1_v0_8_0_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} rustsecp256k1_v0_8_0_modinv32_modinfo;
...
/* Same as rustsecp256k1_v0_8_0_modinv32_var, but constant time in x (not in the modulus). */
