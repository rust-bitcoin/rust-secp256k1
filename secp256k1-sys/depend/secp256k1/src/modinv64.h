...
typedef struct {
    ...
    rustsecp256k1_v0_8_0_modinv64_signed62 modulus;

    /* modulus^{-1} mod 2^62 */
    uint64_t modulus_inv62;
} rustsecp256k1_v0_8_0_modinv64_modinfo;
...
/* Same as rustsecp256k1_v0_8_0_modinv64_var, but constant time in x (not in the modulus). */
