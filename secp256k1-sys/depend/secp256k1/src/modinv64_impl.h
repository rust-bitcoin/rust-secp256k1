...
static int64_t rustsecp256k1_v0_7_0_modinv64_abs(int64_t v) {
    VERIFY_CHECK(v > INT64_MIN);
    if (v < 0) return -v;
    return v;
}

static const rustsecp256k1_v0_7_0_modinv64_signed62 SECP256K1_SIGNED62_ONE = {{1}};

/* Compute a*factor and put it in r. All but the top limb in r will be in range [0,2^62). */
static void rustsecp256k1_v0_7_0_modinv64_mul_62(rustsecp256k1_v0_7_0_modinv64_signed62 *r, const rustsecp256k1_v0_7_0_modinv64_signed62 *a, int alen, int64_t factor) {
...
static int rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(const rustsecp256k1_v0_7_0_modinv64_signed62 *a, int alen, const rustsecp256k1_v0_7_0_modinv64_signed62 *b, int64_t factor) {
    int i;
    rustsecp256k1_v0_7_0_modinv64_signed62 am, bm;
    rustsecp256k1_v0_7_0_modinv64_mul_62(&am, a, alen, 1); /* Normalize all but the top limb of a. */
    rustsecp256k1_v0_7_0_modinv64_mul_62(&bm, b, 5, factor);
    for (i = 0; i < 4; ++i) {
 ...
 * [0,2^62). */
static void rustsecp256k1_v0_7_0_modinv64_normalize_62(rustsecp256k1_v0_7_0_modinv64_signed62 *r, int64_t sign, const rustsecp256k1_v0_7_0_modinv64_modinfo *modinfo) {
    const int64_t M62 = (int64_t)(UINT64_MAX >> 2);
    ...
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(r, 5, &modinfo->modulus, -2) > 0); /* r > -2*modulus */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(r, 5, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
    ...
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(r, 5, &modinfo->modulus, 0) >= 0); /* r >= 0 */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(r, 5, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
}
...
typedef struct {
    int64_t u, v, q, r;
} rustsecp256k1_v0_7_0_modinv64_trans2x2;
 ...
 */
static int64_t rustsecp256k1_v0_7_0_modinv64_divsteps_59(int64_t zeta, uint64_t f0, uint64_t g0, rustsecp256k1_v0_7_0_modinv64_trans2x2 *t) {
 ...
 */
static int64_t rustsecp256k1_v0_7_0_modinv64_divsteps_62_var(int64_t eta, uint64_t f0, uint64_t g0, rustsecp256k1_v0_7_0_modinv64_trans2x2 *t) {
    /* Transformation matrix; see comments in rustsecp256k1_v0_7_0_modinv64_divsteps_62. */
    ...
    for (;;) {
        ...
        zeros = rustsecp256k1_v0_7_0_ctz64_var(g | (UINT64_MAX << i));
 ...
 */
static void rustsecp256k1_v0_7_0_modinv64_update_de_62(rustsecp256k1_v0_7_0_modinv64_signed62 *d, rustsecp256k1_v0_7_0_modinv64_signed62 *e, const rustsecp256k1_v0_7_0_modinv64_trans2x2 *t, const rustsecp256k1_v0_7_0_modinv64_modinfo* modinfo) {
    const int64_t M62 = (int64_t)(UINT64_MAX >> 2);
    ...
    int128_t cd, ce;
#ifdef VERIFY
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(d, 5, &modinfo->modulus, -2) > 0); /* d > -2*modulus */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(d, 5, &modinfo->modulus, 1) < 0);  /* d <    modulus */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(e, 5, &modinfo->modulus, -2) > 0); /* e > -2*modulus */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(e, 5, &modinfo->modulus, 1) < 0);  /* e <    modulus */
    VERIFY_CHECK((rustsecp256k1_v0_7_0_modinv64_abs(u) + rustsecp256k1_v0_7_0_modinv64_abs(v)) >= 0); /* |u|+|v| doesn't overflow */
    VERIFY_CHECK((rustsecp256k1_v0_7_0_modinv64_abs(q) + rustsecp256k1_v0_7_0_modinv64_abs(r)) >= 0); /* |q|+|r| doesn't overflow */
    VERIFY_CHECK((rustsecp256k1_v0_7_0_modinv64_abs(u) + rustsecp256k1_v0_7_0_modinv64_abs(v)) <= M62 + 1); /* |u|+|v| <= 2^62 */
    VERIFY_CHECK((rustsecp256k1_v0_7_0_modinv64_abs(q) + rustsecp256k1_v0_7_0_modinv64_abs(r)) <= M62 + 1); /* |q|+|r| <= 2^62 */
#endif
 ...
 */
static void rustsecp256k1_v0_7_0_modinv64_update_fg_62(rustsecp256k1_v0_7_0_modinv64_signed62 *f, rustsecp256k1_v0_7_0_modinv64_signed62 *g, const rustsecp256k1_v0_7_0_modinv64_trans2x2 *t) {
    const int64_t M62 = (int64_t)(UINT64_MAX >> 2);
 ...
 * This implements the update_fg function from the explanation.
 */
static void rustsecp256k1_v0_7_0_modinv64_update_fg_62_var(int len, rustsecp256k1_v0_7_0_modinv64_signed62 *f, rustsecp256k1_v0_7_0_modinv64_signed62 *g, const rustsecp256k1_v0_7_0_modinv64_trans2x2 *t) {
    const int64_t M62 = (int64_t)(UINT64_MAX >> 2);
    const int64_t u = t->u, v = t->v, q = t->q, r = t->r;
    int64_t fi, gi;
    int128_t cf, cg;
...
static void rustsecp256k1_v0_7_0_modinv64(rustsecp256k1_v0_7_0_modinv64_signed62 *x, const rustsecp256k1_v0_7_0_modinv64_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, zeta=-1. */
    rustsecp256k1_v0_7_0_modinv64_signed62 d = {{0, 0, 0, 0, 0}};
    rustsecp256k1_v0_7_0_modinv64_signed62 e = {{1, 0, 0, 0, 0}};
    rustsecp256k1_v0_7_0_modinv64_signed62 f = modinfo->modulus;
    rustsecp256k1_v0_7_0_modinv64_signed62 g = *x;
    int i;
    ...
    for (i = 0; i < 10; ++i) {
        ...
        rustsecp256k1_v0_7_0_modinv64_trans2x2 t;
        zeta = rustsecp256k1_v0_7_0_modinv64_divsteps_59(zeta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        rustsecp256k1_v0_7_0_modinv64_update_de_62(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, 5, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, 5, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        rustsecp256k1_v0_7_0_modinv64_update_fg_62(&f, &g, &t);
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, 5, &modinfo->modulus, -1) > 0); /* g > -modulus */
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, 5, &SECP256K1_SIGNED62_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &SECP256K1_SIGNED62_ONE, -1) == 0 ||
                 rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &SECP256K1_SIGNED62_ONE, 1) == 0 ||
                 (rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(x, 5, &SECP256K1_SIGNED62_ONE, 0) == 0 &&
                  rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&d, 5, &SECP256K1_SIGNED62_ONE, 0) == 0 &&
                  (rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, 1) == 0 ||
                   rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, 5, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    rustsecp256k1_v0_7_0_modinv64_normalize_62(&d, f.v[4], modinfo);
    *x = d;
}

/* Compute the inverse of x modulo modinfo->modulus, and replace x with it (variable time). */
static void rustsecp256k1_v0_7_0_modinv64_var(rustsecp256k1_v0_7_0_modinv64_signed62 *x, const rustsecp256k1_v0_7_0_modinv64_modinfo *modinfo) {
    ...
    while (1) {
        ...
        rustsecp256k1_v0_7_0_modinv64_trans2x2 t;
        eta = rustsecp256k1_v0_7_0_modinv64_divsteps_62_var(eta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        rustsecp256k1_v0_7_0_modinv64_update_de_62(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, len, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, len, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        rustsecp256k1_v0_7_0_modinv64_update_fg_62_var(len, &f, &g, &t);
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&g, len, &SECP256K1_SIGNED62_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &SECP256K1_SIGNED62_ONE, -1) == 0 ||
                 rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &SECP256K1_SIGNED62_ONE, 1) == 0 ||
                 (rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(x, 5, &SECP256K1_SIGNED62_ONE, 0) == 0 &&
                  rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&d, 5, &SECP256K1_SIGNED62_ONE, 0) == 0 &&
                  (rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &modinfo->modulus, 1) == 0 ||
                   rustsecp256k1_v0_7_0_modinv64_mul_cmp_62(&f, len, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    rustsecp256k1_v0_7_0_modinv64_normalize_62(&d, f.v[len - 1], modinfo);
    *x = d;
}
