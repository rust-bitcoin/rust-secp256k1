...
static void test_ecdsa_recovery_api(void) {
    ...
    rustsecp256k1_v0_8_1_context_set_error_callback(STATIC_CTX, counting_illegal_callback_fn, &ecount);
    ...
    CHECK(ecount == 3);
    CHECK(rustsecp256k1_v0_8_1_ecdsa_sign_recoverable(STATIC_CTX, &recsig, message, privkey, NULL, NULL) == 0);
    CHECK(ecount == 4);
