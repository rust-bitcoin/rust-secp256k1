...
void nonce_function_bip340_bitflip(unsigned char **args, size_t n_flip, size_t n_bytes) {
    ...
    rustsecp256k1_v0_3_1_testrand_flip(args[n_flip], n_bytes);
...
void test_sha256_eq(const rustsecp256k1_v0_3_1_sha256 *sha1, const rustsecp256k1_v0_3_1_sha256 *sha2) {
...
void run_nonce_function_bip340_tests(void) {
    ...
    rustsecp256k1_v0_3_1_sha256 sha_optimized;
     ...
     * rustsecp256k1_v0_3_1_nonce_function_bip340_sha256_tagged has the expected
     * state. */
    rustsecp256k1_v0_3_1_sha256_initialize_tagged(&sha, tag, sizeof(tag));
    rustsecp256k1_v0_3_1_nonce_function_bip340_sha256_tagged(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * rustsecp256k1_v0_3_1_nonce_function_bip340_sha256_tagged_aux has the expected
    * state. */
    rustsecp256k1_v0_3_1_sha256_initialize_tagged(&sha, aux_tag, sizeof(aux_tag));
    rustsecp256k1_v0_3_1_nonce_function_bip340_sha256_tagged_aux(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);

    rustsecp256k1_v0_3_1_testrand256(msg);
    rustsecp256k1_v0_3_1_testrand256(key);
    rustsecp256k1_v0_3_1_testrand256(pk);
    rustsecp256k1_v0_3_1_testrand256(aux_rand);
...
void test_schnorrsig_api(void) {
    ...
    unsigned char msg[32];
    rustsecp256k1_v0_3_1_keypair keypairs[3];
    rustsecp256k1_v0_3_1_keypair invalid_keypair = { 0 };
    rustsecp256k1_v0_3_1_xonly_pubkey pk[3];
    rustsecp256k1_v0_3_1_xonly_pubkey zero_pk;
    ...
    rustsecp256k1_v0_3_1_testrand256(sk1);
    rustsecp256k1_v0_3_1_testrand256(sk2);
    rustsecp256k1_v0_3_1_testrand256(sk3);
    rustsecp256k1_v0_3_1_testrand256(msg);
    CHECK(rustsecp256k1_v0_3_1_keypair_create(ctx, &keypairs[0], sk1) == 1);
    CHECK(rustsecp256k1_v0_3_1_keypair_create(ctx, &keypairs[1], sk2) == 1);
    CHECK(rustsecp256k1_v0_3_1_keypair_create(ctx, &keypairs[2], sk3) == 1);
    CHECK(rustsecp256k1_v0_3_1_keypair_xonly_pub(ctx, &pk[0], NULL, &keypairs[0]) == 1);
    CHECK(rustsecp256k1_v0_3_1_keypair_xonly_pub(ctx, &pk[1], NULL, &keypairs[1]) == 1);
    CHECK(rustsecp256k1_v0_3_1_keypair_xonly_pub(ctx, &pk[2], NULL, &keypairs[2]) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));

    /** main test body **/
    ecount = 0;
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(none, sig, msg, &keypairs[0], NULL, NULL) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(vrfy, sig, msg, &keypairs[0], NULL, NULL) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, sig, msg, &keypairs[0], NULL, NULL) == 1);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, NULL, msg, &keypairs[0], NULL, NULL) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, sig, NULL, &keypairs[0], NULL, NULL) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, sig, msg, NULL, NULL, NULL) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, sig, msg, &invalid_keypair, NULL, NULL) == 0);
    CHECK(ecount == 6);

    ecount = 0;
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(sign, sig, msg, &keypairs[0], NULL, NULL) == 1);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(none, sig, msg, &pk[0]) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(sign, sig, msg, &pk[0]) == 0);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(vrfy, sig, msg, &pk[0]) == 1);
    CHECK(ecount == 2);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(vrfy, NULL, msg, &pk[0]) == 0);
    CHECK(ecount == 3);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(vrfy, sig, NULL, &pk[0]) == 0);
    CHECK(ecount == 4);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(vrfy, sig, msg, NULL) == 0);
    CHECK(ecount == 5);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(vrfy, sig, msg, &zero_pk) == 0);
    CHECK(ecount == 6);
...
/* Checks that hash initialized by rustsecp256k1_v0_3_1_schnorrsig_sha256_tagged has the
 * expected state. */
void test_schnorrsig_sha256_tagged(void) {
    ...
    rustsecp256k1_v0_3_1_sha256_initialize_tagged(&sha, (unsigned char *) tag, sizeof(tag));
    rustsecp256k1_v0_3_1_schnorrsig_sha256_tagged(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);
}
...
void test_schnorrsig_bip_vectors_check_signing(const unsigned char *sk, const unsigned char *pk_serialized, unsigned char *aux_rand, const unsigned char *msg, const unsigned char *expected_sig) {
    ...
    rustsecp256k1_v0_3_1_xonly_pubkey pk, pk_expected;

    CHECK(rustsecp256k1_v0_3_1_keypair_create(ctx, &keypair, sk));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, NULL, aux_rand));
    CHECK(memcmp(sig, expected_sig, 64) == 0);

    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_parse(ctx, &pk_expected, pk_serialized));
    CHECK(rustsecp256k1_v0_3_1_keypair_xonly_pub(ctx, &pk, NULL, &keypair));
    CHECK(memcmp(&pk, &pk_expected, sizeof(pk)) == 0);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig, msg, &pk));
}
...
void test_schnorrsig_bip_vectors_check_verify(const unsigned char *pk_serialized, const unsigned char *msg32, const unsigned char *sig, int expected) {
    ...
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_parse(ctx, &pk, pk_serialized));
    CHECK(expected == rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig, msg32, &pk));
}
...
void test_schnorrsig_bip_vectors(void) {
    ...
    }
    {
        ...
        rustsecp256k1_v0_3_1_xonly_pubkey pk_parsed;
        /* No need to check the signature of the test vector as parsing the pubkey already fails */
        CHECK(!rustsecp256k1_v0_3_1_xonly_pubkey_parse(ctx, &pk_parsed, pk));
    }
    {
        /* Test vector 6 */
        const unsigned char pk[32] = {
...
void test_schnorrsig_sign(void) {
    ...
    CHECK(rustsecp256k1_v0_3_1_keypair_create(ctx, &keypair, sk));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, NULL, NULL) == 1);

    /* Test different nonce functions */
    memset(sig, 1, sizeof(sig));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, nonce_function_failing, NULL) == 0);
    CHECK(memcmp(sig, zeros64, sizeof(sig)) == 0);
    memset(&sig, 1, sizeof(sig));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, nonce_function_0, NULL) == 0);
    CHECK(memcmp(sig, zeros64, sizeof(sig)) == 0);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, nonce_function_overflowing, NULL) == 1);
    CHECK(memcmp(sig, zeros64, sizeof(sig)) != 0);
}
...
void test_schnorrsig_sign_verify(void) {
    ...
    for (i = 0; i < N_SIGS; i++) {
        rustsecp256k1_v0_3_1_testrand256(msg[i]);
        CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig[i], msg[i], &keypair, NULL, NULL));
        CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig[i], msg[i], &pk));
    }

    {
        /* Flip a few bits in the signature and in the message and check that
         * verify and verify_batch (TODO) fail */
        size_t sig_idx = rustsecp256k1_v0_3_1_testrand_int(N_SIGS);
        size_t byte_idx = rustsecp256k1_v0_3_1_testrand_int(32);
        unsigned char xorbyte = rustsecp256k1_v0_3_1_testrand_int(254)+1;
        sig[sig_idx][byte_idx] ^= xorbyte;
        CHECK(!rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig[sig_idx], msg[sig_idx], &pk));
        sig[sig_idx][byte_idx] ^= xorbyte;

        byte_idx = rustsecp256k1_v0_3_1_testrand_int(32);
    ...
    /* Test overflowing s */
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig[0], msg[0], &keypair, NULL, NULL));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig[0], msg[0], &pk));
    ...
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig[0], msg[0], &keypair, NULL, NULL));
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig[0], msg[0], &pk));
    rustsecp256k1_v0_3_1_scalar_set_b32(&s, &sig[0][32], NULL);
    rustsecp256k1_v0_3_1_scalar_negate(&s, &s);
    rustsecp256k1_v0_3_1_scalar_get_b32(&sig[0][32], &s);
    CHECK(!rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig[0], msg[0], &pk));
}
#undef N_SIGS
...
void test_schnorrsig_taproot(void) {
    ...
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_serialize(ctx, tweak, &internal_pk) == 1);
    ...
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_serialize(ctx, output_pk_bytes, &output_pk) == 1);

    /* Key spend */
    rustsecp256k1_v0_3_1_testrand256(msg);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_sign(ctx, sig, msg, &keypair, NULL, NULL) == 1);
    /* Verify key spend */
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_parse(ctx, &output_pk, output_pk_bytes) == 1);
    CHECK(rustsecp256k1_v0_3_1_schnorrsig_verify(ctx, sig, msg, &output_pk) == 1);

    /* Script spend */
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_serialize(ctx, internal_pk_bytes, &internal_pk) == 1);
    /* Verify script spend */
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_parse(ctx, &internal_pk, internal_pk_bytes) == 1);
    CHECK(rustsecp256k1_v0_3_1_xonly_pubkey_tweak_add_check(ctx, output_pk_bytes, pk_parity, &internal_pk, tweak) == 1);
}
