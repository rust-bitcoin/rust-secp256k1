...
#ifdef VERIFY
static void rustsecp256k1_v0_2_0_num_sanity(const rustsecp256k1_v0_2_0_num *a) {
    VERIFY_CHECK(a->limbs == 1 || (a->limbs > 1 && a->data[a->limbs-1] != 0));
}
#else
#define rustsecp256k1_v0_2_0_num_sanity(a) do { } while(0)
#endif
...
static void rustsecp256k1_v0_2_0_num_add_abs(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
...
static void rustsecp256k1_v0_2_0_num_sub_abs(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
...
static void rustsecp256k1_v0_2_0_num_mod(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *m) {
    rustsecp256k1_v0_2_0_num_sanity(r);
    rustsecp256k1_v0_2_0_num_sanity(m);
    ...
    if (r->neg && (r->limbs > 1 || r->data[0] != 0)) {
        rustsecp256k1_v0_2_0_num_sub_abs(r, m, r);
        r->neg = 0;
    }
}
...
static void rustsecp256k1_v0_2_0_num_mod_inverse(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *m) {
    ...
    mp_size_t sn;
    mp_size_t gn;
    rustsecp256k1_v0_2_0_num_sanity(a);
    rustsecp256k1_v0_2_0_num_sanity(m);
...
static int rustsecp256k1_v0_2_0_num_jacobi(const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
    ...
    mpz_t ga, gb;
    rustsecp256k1_v0_2_0_num_sanity(a);
    rustsecp256k1_v0_2_0_num_sanity(b);
...
static int rustsecp256k1_v0_2_0_num_eq(const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
    ...
    if ((a->neg && !rustsecp256k1_v0_2_0_num_is_zero(a)) != (b->neg && !rustsecp256k1_v0_2_0_num_is_zero(b))) {
        return 0;
    }
    return mpn_cmp(a->data, b->data, a->limbs) == 0;
}

static void rustsecp256k1_v0_2_0_num_subadd(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b, int bneg) {
    if (!(b->neg ^ bneg ^ a->neg)) { /* a and b have the same sign */
        r->neg = a->neg;
        if (a->limbs >= b->limbs) {
            rustsecp256k1_v0_2_0_num_add_abs(r, a, b);
        } else {
            rustsecp256k1_v0_2_0_num_add_abs(r, b, a);
        }
    } else {
        if (rustsecp256k1_v0_2_0_num_cmp(a, b) > 0) {
            r->neg = a->neg;
            rustsecp256k1_v0_2_0_num_sub_abs(r, a, b);
        } else {
            r->neg = b->neg ^ bneg;
            rustsecp256k1_v0_2_0_num_sub_abs(r, b, a);
        }
    }
}
...
static void rustsecp256k1_v0_2_0_num_add(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
    rustsecp256k1_v0_2_0_num_sanity(a);
    rustsecp256k1_v0_2_0_num_sanity(b);
    rustsecp256k1_v0_2_0_num_subadd(r, a, b, 0);
}
...
static void rustsecp256k1_v0_2_0_num_sub(rustsecp256k1_v0_2_0_num *r, const rustsecp256k1_v0_2_0_num *a, const rustsecp256k1_v0_2_0_num *b) {
    rustsecp256k1_v0_2_0_num_sanity(a);
    rustsecp256k1_v0_2_0_num_sanity(b);
    rustsecp256k1_v0_2_0_num_subadd(r, a, b, 1);
}
