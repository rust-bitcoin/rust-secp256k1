...
static void print_table(FILE *fp, const char *name, int window_g, const rustsecp256k1_v0_8_1_ge_storage* table) {
    int j;
    int i;

    fprintf(fp, "const rustsecp256k1_v0_8_1_ge_storage %s[ECMULT_TABLE_SIZE(WINDOW_G)] = {\n", name);
...
static void print_two_tables(FILE *fp, int window_g) {
    rustsecp256k1_v0_8_1_ge_storage* table = malloc(ECMULT_TABLE_SIZE(window_g) * sizeof(rustsecp256k1_v0_8_1_ge_storage));
    rustsecp256k1_v0_8_1_ge_storage* table_128 = malloc(ECMULT_TABLE_SIZE(window_g) * sizeof(rustsecp256k1_v0_8_1_ge_storage));

    rustsecp256k1_v0_8_1_ecmult_compute_two_tables(table, table_128, window_g, &rustsecp256k1_v0_8_1_ge_const_g);

    print_table(fp, "rustsecp256k1_v0_8_1_pre_g", window_g, table);
    print_table(fp, "rustsecp256k1_v0_8_1_pre_g_128", window_g, table_128);
