...
int main(int argc, char **argv) {
    ...
    for (bits = 2; bits <= 8; bits *= 2) {
        ...
        rustsecp256k1_v0_9_2_ge_storage* table = checked_malloc(&default_error_callback, n * g * sizeof(rustsecp256k1_v0_9_2_ge_storage));
        rustsecp256k1_v0_9_2_ecmult_gen_compute_table(table, &rustsecp256k1_v0_9_2_ge_const_g, bits);
