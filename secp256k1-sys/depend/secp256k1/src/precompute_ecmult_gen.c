...
static void print_table(FILE* fp, int blocks, int teeth) {
    ...
    rustsecp256k1_v0_13_ge_storage* table = checked_malloc(&default_error_callback, blocks * points * sizeof(rustsecp256k1_v0_13_ge_storage));
    rustsecp256k1_v0_13_ecmult_gen_compute_table(table, &rustsecp256k1_v0_13_ge_const_g, blocks, teeth, spacing);
...
int main(int argc, char **argv) {
    ...
    fprintf(fp, "const rustsecp256k1_v0_13_ge_storage rustsecp256k1_v0_13_ecmult_gen_prec_table[COMB_BLOCKS][COMB_POINTS] = {\n");
    fprintf(fp, "#if 0\n");
