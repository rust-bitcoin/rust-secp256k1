...
static void rustsecp256k1_v0_12_scalar_clear(rustsecp256k1_v0_12_scalar *r);

/** Access bits (1 < count <= 32) from a scalar. All requested bits must belong to the same 32-bit limb. */
static uint32_t rustsecp256k1_v0_12_scalar_get_bits_limb32(const rustsecp256k1_v0_12_scalar *a, unsigned int offset, unsigned int count);

/** Access bits (1 < count <= 32) from a scalar. offset + count must be < 256. Not constant time in offset and count. */
static uint32_t rustsecp256k1_v0_12_scalar_get_bits_var(const rustsecp256k1_v0_12_scalar *a, unsigned int offset, unsigned int count);
 ...
 */
static void rustsecp256k1_v0_12_scalar_set_b32(rustsecp256k1_v0_12_scalar *r, const unsigned char *bin, int *overflow);
...
static void rustsecp256k1_v0_12_scalar_set_int(rustsecp256k1_v0_12_scalar *r, unsigned int v);
...
static void rustsecp256k1_v0_12_scalar_inverse(rustsecp256k1_v0_12_scalar *r, const rustsecp256k1_v0_12_scalar *a);

/** Compute the inverse of a scalar (modulo the group order), without constant-time guarantee. */
static void rustsecp256k1_v0_12_scalar_inverse_var(rustsecp256k1_v0_12_scalar *r, const rustsecp256k1_v0_12_scalar *a);
...
static int rustsecp256k1_v0_12_scalar_is_zero(const rustsecp256k1_v0_12_scalar *a);

/** Check whether a scalar equals one. */
static int rustsecp256k1_v0_12_scalar_is_one(const rustsecp256k1_v0_12_scalar *a);

/** Check whether a scalar, considered as an nonnegative integer, is even. */
static int rustsecp256k1_v0_12_scalar_is_even(const rustsecp256k1_v0_12_scalar *a);
...
static int rustsecp256k1_v0_12_scalar_cond_negate(rustsecp256k1_v0_12_scalar *a, int flag);

/** Compare two scalars. */
static int rustsecp256k1_v0_12_scalar_eq(const rustsecp256k1_v0_12_scalar *a, const rustsecp256k1_v0_12_scalar *b);
 ...
 *  negations are maximum 128 bits long (see rustsecp256k1_v0_12_ge_mul_lambda). It is
...
static void rustsecp256k1_v0_12_scalar_mul_shift_var(rustsecp256k1_v0_12_scalar *r, const rustsecp256k1_v0_12_scalar *a, const rustsecp256k1_v0_12_scalar *b, unsigned int shift);

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized.*/
static void rustsecp256k1_v0_12_scalar_cmov(rustsecp256k1_v0_12_scalar *r, const rustsecp256k1_v0_12_scalar *a, int flag);
...
#define SECP256K1_SCALAR_VERIFY(r) rustsecp256k1_v0_12_scalar_verify(r)
