...
SECP256K1_INLINE static int rustsecp256k1_v0_6_1_scalar_reduce(rustsecp256k1_v0_6_1_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static void rustsecp256k1_v0_6_1_scalar_negate(rustsecp256k1_v0_6_1_scalar *r, const rustsecp256k1_v0_6_1_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (rustsecp256k1_v0_6_1_scalar_is_zero(a) == 0);
...
static int rustsecp256k1_v0_6_1_scalar_cond_negate(rustsecp256k1_v0_6_1_scalar *r, int flag) {
    ...
    uint32_t nonzero = 0xFFFFFFFFUL * (rustsecp256k1_v0_6_1_scalar_is_zero(r) == 0);
...
static void rustsecp256k1_v0_6_1_scalar_reduce_512(rustsecp256k1_v0_6_1_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void rustsecp256k1_v0_6_1_scalar_mul_512(uint32_t *l, const rustsecp256k1_v0_6_1_scalar *a, const rustsecp256k1_v0_6_1_scalar *b) {
    /* 96 bit accumulator. */
...
SECP256K1_INLINE static void rustsecp256k1_v0_6_1_scalar_mul_shift_var(rustsecp256k1_v0_6_1_scalar *r, const rustsecp256k1_v0_6_1_scalar *a, const rustsecp256k1_v0_6_1_scalar *b, unsigned int shift) {
    ...
    rustsecp256k1_v0_6_1_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 5] >> ((shift - 1) & 0x1f)) & 1);
}
...
static void rustsecp256k1_v0_6_1_scalar_from_signed30(rustsecp256k1_v0_6_1_scalar *r, const rustsecp256k1_v0_6_1_modinv32_signed30 *a) {
...
static void rustsecp256k1_v0_6_1_scalar_to_signed30(rustsecp256k1_v0_6_1_modinv32_signed30 *r, const rustsecp256k1_v0_6_1_scalar *a) {
...
static const rustsecp256k1_v0_6_1_modinv32_modinfo rustsecp256k1_v0_6_1_const_modinfo_scalar = {
...
#endif
    rustsecp256k1_v0_6_1_scalar_to_signed30(&s, x);
    rustsecp256k1_v0_6_1_modinv32(&s, &rustsecp256k1_v0_6_1_const_modinfo_scalar);
    rustsecp256k1_v0_6_1_scalar_from_signed30(r, &s);
...
#endif
    rustsecp256k1_v0_6_1_scalar_to_signed30(&s, x);
    rustsecp256k1_v0_6_1_modinv32_var(&s, &rustsecp256k1_v0_6_1_const_modinfo_scalar);
    rustsecp256k1_v0_6_1_scalar_from_signed30(r, &s);
