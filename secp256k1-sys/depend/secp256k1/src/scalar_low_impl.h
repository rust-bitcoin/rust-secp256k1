...
SECP256K1_INLINE static int rustsecp256k1_v0_12_scalar_check_overflow(const rustsecp256k1_v0_12_scalar *a) { return *a >= EXHAUSTIVE_TEST_ORDER; }
...
static int rustsecp256k1_v0_12_scalar_cond_negate(rustsecp256k1_v0_12_scalar *r, int flag) {
    ...
    if (flag) rustsecp256k1_v0_12_scalar_negate(r, r);
...
static void rustsecp256k1_v0_12_scalar_split_128(rustsecp256k1_v0_12_scalar *r1, rustsecp256k1_v0_12_scalar *r2, const rustsecp256k1_v0_12_scalar *a) {
    SECP256K1_SCALAR_VERIFY(a);
...
static void rustsecp256k1_v0_12_scalar_inverse_var(rustsecp256k1_v0_12_scalar *r, const rustsecp256k1_v0_12_scalar *x) {
    ...
    rustsecp256k1_v0_12_scalar_inverse(r, x);
