...
static size_t rustsecp256k1_v0_9_2_scratch_checkpoint(const rustsecp256k1_v0_9_2_callback* error_callback, const rustsecp256k1_v0_9_2_scratch* scratch) {
    if (rustsecp256k1_v0_9_2_memcmp_var(scratch->magic, "scratch", 8) != 0) {
        rustsecp256k1_v0_9_2_callback_call(error_callback, "invalid scratch space");
        return 0;
    }
...
static void rustsecp256k1_v0_9_2_scratch_apply_checkpoint(const rustsecp256k1_v0_9_2_callback* error_callback, rustsecp256k1_v0_9_2_scratch* scratch, size_t checkpoint) {
    ...
    if (checkpoint > scratch->alloc_size) {
        rustsecp256k1_v0_9_2_callback_call(error_callback, "invalid checkpoint");
        return;
    }
    scratch->alloc_size = checkpoint;
}

static size_t rustsecp256k1_v0_9_2_scratch_max_allocation(const rustsecp256k1_v0_9_2_callback* error_callback, const rustsecp256k1_v0_9_2_scratch* scratch, size_t objects) {
    if (rustsecp256k1_v0_9_2_memcmp_var(scratch->magic, "scratch", 8) != 0) {
        rustsecp256k1_v0_9_2_callback_call(error_callback, "invalid scratch space");
        return 0;
    }
...
static void *rustsecp256k1_v0_9_2_scratch_alloc(const rustsecp256k1_v0_9_2_callback* error_callback, rustsecp256k1_v0_9_2_scratch* scratch, size_t size) {
    void *ret;
    size_t rounded_size;
