...
static int rustsecp256k1_v0_3_1_selftest_sha256(void) {
    ...
    rustsecp256k1_v0_3_1_sha256_write(&hasher, (const unsigned char*)input63, 63);
    rustsecp256k1_v0_3_1_sha256_finalize(&hasher, out);
    return memcmp(out, output32, 32) == 0;
}

static int rustsecp256k1_v0_3_1_selftest(void) {
    return rustsecp256k1_v0_3_1_selftest_sha256();
}
