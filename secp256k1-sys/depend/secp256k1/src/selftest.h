...
static int rustsecp256k1_v0_5_0_selftest_sha256(void) {
    ...
    rustsecp256k1_v0_5_0_sha256_write(&hasher, (const unsigned char*)input63, 63);
    rustsecp256k1_v0_5_0_sha256_finalize(&hasher, out);
    return rustsecp256k1_v0_5_0_memcmp_var(out, output32, 32) == 0;
}

static int rustsecp256k1_v0_5_0_selftest(void) {
    return rustsecp256k1_v0_5_0_selftest_sha256();
}
