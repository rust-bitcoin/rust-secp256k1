...
#[cfg(not(feature = "fuzztarget"))]
extern "C" {
    #[cfg_attr(not(feature = "external-symbols"), link_name = "rustsecp256k1_v0_2_0_ecdsa_recoverable_signature_parse_compact")]
    ...
    #[cfg_attr(not(feature = "external-symbols"), link_name = "rustsecp256k1_v0_2_0_ecdsa_recoverable_signature_serialize_compact")]
    pub fn secp256k1_ecdsa_recoverable_signature_serialize_compact(cx: *const Context, output64: *mut c_uchar,
                                                                   recid: *mut c_int, sig: *const RecoverableSignature)
                                                                   -> c_int;

    #[cfg_attr(not(feature = "external-symbols"), link_name = "rustsecp256k1_v0_2_0_ecdsa_recoverable_signature_convert")]
    pub fn secp256k1_ecdsa_recoverable_signature_convert(cx: *const Context, sig: *mut Signature,
                                                         input: *const RecoverableSignature)
                                                         -> c_int;
    #[cfg_attr(not(feature = "external-symbols"), link_name = "rustsecp256k1_v0_2_0_ecdsa_sign_recoverable")]
    ...
    #[cfg_attr(not(feature = "external-symbols"), link_name = "rustsecp256k1_v0_2_0_ecdsa_recover")]
