...
mod test {
    ...
    use super::{PublicKey, SecretKey, XOnlyPubkey, KeyPair};
    ...
    #[test]
    fn test_xonly_pubkey_from_slice() {
    ...
    #[test]
    fn test_xonly_pubkey_serialize_roundtrip() {
    ...
    #[test]
    fn test_xonly_pubkey_from_bad_slice() {
        // Bad sizes
        assert_eq!(
    ...
    #[test]
    fn test_xonly_pubkey_display_output() {
        let secp = Secp256k1::new();
        static SK_BYTES: [u8; 32] = [
    ...
    #[cfg(not(fuzzing))]
    fn test_xonly_pubkey_serialize() {
        struct DumbRng(u32);
        impl RngCore for DumbRng {
            fn next_u32(&mut self) -> u32 {
                self.0 = self.0.wrapping_add(1);
