...
impl Secp256k1<None> {
    /// Creates a new Secp256k1 context with no capabilities (only used internally)
    fn without_caps() -> Secp256k1<None> {
...
mod tests {
    ...
    #[test]
    fn capabilities() {
        let _none = Secp256k1::without_caps();  // literally unused
