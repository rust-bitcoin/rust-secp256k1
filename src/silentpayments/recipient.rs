...
impl Label {
    ...
    ///
    /// # Returns
    /// A tuple ([`Label`], [u8; 32]) where the first element is the label representation as a
    /// group element and the second is the label representation as a scalar in the field.
    ///
    /// # Errors
